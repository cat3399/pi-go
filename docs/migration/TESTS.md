...
| `T-SESSION-014` | B-SESSION-015 | coding/Harness `compaction.ts::{estimateContextTokens,findCutPoint,shouldCompact}` | `implemented; review pending` | assistant-usage/trailing estimate, tool-result-safe cut and fuzz; automatic trigger remains deferred |
