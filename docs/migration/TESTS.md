...
| `T-RESOURCE-002` | B-RESOURCE-002 | trust-manager tests | `implemented-awaiting-independent-review` | boolean/null/future raw preservation, cancellable local serialization, atomic/commit-unknown reconcile, permission/race; Windows compile fail-closed |
