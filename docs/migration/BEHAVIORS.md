...
| `B-TUI-003` | ANSI-invisible cell width, CJK/combining/emoji/RI/tab, contiguous truncate, whitespace wrap and cell slicing | `src/utils.ts`; width/wrap/truncate regression tests | `in-progress` | Myanmar/Indic、indent/RI、wide ellipsis、ZWJ/control 与 stateful ANSI/OSC-8 slice regressions complete; awaiting rereview |
