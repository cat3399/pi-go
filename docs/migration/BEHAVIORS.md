...
| `B-SESSION-008` | coding-agent v1/v2 自动迁移到 v3 | coding migration tests/fixtures | `implemented-awaiting-review` | Open source-snapshot/pure migration/atomic rewrite；explicit trailing-partial recovery、alias locks 与 Windows `FileRenameInfoEx` runtime review gate 见 SESSION_STORAGE |
