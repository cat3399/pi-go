...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.runningInputTitle": "Messages while a task is running",
    "settings.runningInputDescription": "Choose what Send does when the agent is already working.",
    "settings.steer": "Insert into current run",
    "settings.steerDescription": "Deliver the message before the current task's next model call.",
    "settings.followUp": "Queue for the next turn",
    "settings.followUpDescription": "Send the message automatically after the current task finishes.",
    "settings.singleActionHint": "While a task is running, the composer shows Stop when empty and Send when it contains text.",
    ...
    "chat.steerPlaceholder": "Type a message to send while this task runs...",
    ...
    "i18n.editFromHere": "Edit",
    "i18n.editFromHereTitle": "Edit this message and continue from here",
