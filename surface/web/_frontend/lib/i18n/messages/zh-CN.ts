...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "common.settings": "设置",
    "settings.close": "关闭设置",
    "settings.runningInputTitle": "任务运行时发送",
    "settings.runningInputDescription": "选择 Agent 正在工作时，发送按钮如何处理新消息。",
    "settings.steer": "插入当前运行",
    "settings.steerDescription": "在当前任务下一次模型调用前送入这条消息。",
    "settings.followUp": "排到下一轮",
    "settings.followUpDescription": "当前任务结束后，自动把这条消息作为下一轮输入。",
    "settings.singleActionHint": "任务运行时，输入框为空显示停止按钮；有文字时，同一位置切换为发送按钮。",
    "sidebar.hide": "隐藏侧边栏",
    "sidebar.show": "显示侧边栏",
    "theme.light": "切换到浅色模式",
    "theme.dark": "切换到深色模式",
    ...
    "chat.steerPlaceholder": "输入消息以在任务运行时发送…",
    ...
    "i18n.editFromHere": "编辑",
    "i18n.editFromHereTitle": "编辑这条消息并从这里继续",
    "i18n.newSession": "新会话",
