...
func Capabilities() []Capability {
	return []Capability{
		...
		{ID: "models", Status: CapabilityComplete, Description: "production model selection, configured-provider filtering, API keys, OAuth, discovery, catalog search and probes are implemented in Go"},
		{ID: "files", Status: CapabilityComplete, Description: "authorized file browsing, text/media/document preview, download ranges, live watch, uploads and file indexing are implemented in Go"},
		{ID: "git_worktrees", Status: CapabilityComplete, Description: "Git status, line statistics, file diffs and worktree lifecycle are implemented in Go"},
